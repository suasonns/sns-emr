...
| 9. ACP & Goals of Care | scattered across `demographics`/`diagnoses` (no dedicated module) | same | Only 3 of the fields shown in the Figma frame are confirmed hard-required; Advance Directives/POA/CPR/Decision Maker unconfirmed |
