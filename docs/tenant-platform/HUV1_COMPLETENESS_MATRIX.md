...
| I0000 | RnicaAssessment(HUV1).form_data | `diagnosisEntries(diagnoses)` | list join | none | **OPEN_QUESTION** (see `I0000_PROVENANCE_TRACE.md`) |
...
— CMS-text-level re-derivation backlog, not a proven defect, except for
J2052C, I0000, J2050, and the N05xx medication-source gap (all
