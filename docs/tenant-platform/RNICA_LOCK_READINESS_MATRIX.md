...
| Advance Directives / POA / Decision Maker / CPR Preference | Unclear | **Not found in `RN_ICA_REQUIRED_FIELD_GROUPS`** | ACP & Goals of Care | `[IMPLEMENTATION DISCOVERY REQUIRED]` | n/a |
...
| Fall Risk / Morse score | Shown prominently in product screenshot | **Not found** in `RN_ICA_REQUIRED_FIELD_GROUPS` | Safety & Clinical Risk | `[IMPLEMENTATION DISCOVERY REQUIRED]` | n/a |
