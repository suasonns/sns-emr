...
- Documentation may be completed after care
...
### Required Emphasis
- Symptom recognition (pain, bowel, dyspnea, agitation, skin integrity)
...
- RN daily assessment expected to justify continuation when CC spans > 1 day
- Disciplines supported clinically: RN, LVN, CHHA, MSW, SC
...
## 11. Linked Execution Artifacts (ANTI-DRIFT)

- `SNS_EMR_QUALITY_GUARDRAILS_IMPLEMENTATION_CHECKLIST.md`
- `SNS_EMR_QUALITY_GUARDRAILS_ACCEPTANCE_CRITERIA.md`
- `SNS_EMR_QAPI_DASHBOARD_ALIGNMENT.md`

---

**Purpose:** Protect patients. Protect staff. Protect the organization.
