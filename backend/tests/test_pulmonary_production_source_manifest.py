...
def test_only_authorized_files_changed():
    ...
    allowed_suffixes = (
        "backend/manifests/pulmonary_production_source_manifest_v1.json",
        "backend/scripts/import_pulmonary_production_source_manifest.py",
        "backend/tests/test_pulmonary_production_source_manifest.py",
        "backend/artifacts/pulmonary_production_manifest_acceptance_v1.json",
    )
